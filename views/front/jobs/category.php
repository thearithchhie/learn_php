    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <!-- Search Form -->
                    <form action="/jobs/category/<?= htmlspecialchars($category->slug) ?>" method="GET" class="mb-4">
                        <div class="mb-3">
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h2 mb-1"><?= htmlspecialchars($category->name) ?> Jobs</h1>
                    <p class="text-muted mb-0">Browse all <?= strtolower(htmlspecialchars($category->name)) ?> jobs</p>
                </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body text-center py-5">
                    <h3 class="h5 text-muted">No jobs found in this category</h3>
